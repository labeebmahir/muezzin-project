...
import { ChevronLeft, Search, X, Navigation } from 'lucide-vue-next'
  ...
  <div class="min-h-screen pb-10">
    ...
    <div class="flex flex-col gap-2 px-4 pt-1">
      ...
      <button
        ...
        :class="isAutoSelected ? 'bg-gold' : 'bg-card border border-(--bdr) hover:bg-white/5'"
        @click="selectAuto"
      >
      ...
      <button
        ...
        :class="settings.locationMode === 'manual' && settings.district === item.district
          ? 'bg-gold'
          : 'bg-card border border-(--bdr) hover:bg-white/5'"
